...
AU05_SynchronizationHud::AU05_SynchronizationHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AU05_SynchronizationHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		AU05_SynchronizationPawn* Vehicle = Cast<AU05_SynchronizationPawn>(GetOwningPawn());
